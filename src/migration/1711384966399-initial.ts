...
export class Initial1711384966399 implements MigrationInterface {
    name = 'Initial1711384966399'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fav_artist" ("id" SERIAL NOT NULL, "artistId" uuid, CONSTRAINT "REL_b0a31c3cda67e480e04ebb0821" UNIQUE ("artistId"), CONSTRAINT "PK_483d97db9d234bbb2188384d645" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fav_album" ("id" SERIAL NOT NULL, "albumId" uuid, CONSTRAINT "REL_5b043828a94ce8e01e39213cb0" UNIQUE ("albumId"), CONSTRAINT "PK_b6c134b9b6ac2d7b457782a86d1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fav_track" ("id" SERIAL NOT NULL, "trackId" uuid, CONSTRAINT "REL_be7cfde4a093b852b61dda6f9f" UNIQUE ("trackId"), CONSTRAINT "PK_11f7c5379a0db5b3402b0d8ec33" PRIMARY KEY ("id"))`);
